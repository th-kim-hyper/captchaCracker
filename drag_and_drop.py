...
class DragAndDrop(tk.Frame):
    def __init__(self, master):
        ...
        self.master.tag_bind(tag, "<ButtonPress-1>", self.move_start)
        self.master.tag_bind(tag, "<ButtonRelease-1>", self.move_stop)
        self.master.tag_bind(tag, "<B1-Motion>", self.move)
